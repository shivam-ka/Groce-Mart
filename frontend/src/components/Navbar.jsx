...
const Nav = () => {
  ...
  const query =
    searchParams.get("query")?.toLocaleString().replaceAll("+", " ") || "";
      ...
      <div className="mx-auto px-0.5 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <Link to="/" className="flex items-center gap-0 md:gap-3">
            <img
              className="ml-0.5 w-9 h-9 md:w-12 md:h-12"
              src={asstes.logo}
              alt="Groce Mart Logo"
            />
              ...
              cartQuantity > 0 && (
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`flex items-center justify-center gap-2 text-white font-medium py-3 px-6 rounded-full shadow-lg ${
                      cartQuantity > 0
                  ...
                  {user._id ? (
                    user.role === "ADMIN" ? (
                      <>
                        <li
                          onClick={() =>
                            profileMenuHandler("/dashboard/category")
                          }
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                        ...
                        <li
                          onClick={() =>
                            profileMenuHandler("/dashboard/sub-category")
                          }
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                        ...
                        <li
                          onClick={() =>
                            profileMenuHandler("/dashboard/upload-product")
                          }
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                        ...
                        <li
                          onClick={() =>
                            profileMenuHandler("/dashboard/product")
                          }
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                        ...
                        <li
                          onClick={() =>
                            profileMenuHandler("/dashboard/orders")
                          }
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                      ...
                      <>
                        <li
                          onClick={() => profileMenuHandler("/dashboard")}
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                        ...
                        <li
                          onClick={() => (
                            setIsProfileMenuOpen(false), setIsCartOpen(true)
                          )}
                          className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                        >
                    ...
                    <>
                      <li
                        onClick={() => profileMenuHandler("/register")}
                        className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c] "
                      >
                      ...
                      <li
                        onClick={() => profileMenuHandler("/login")}
                        className="cursor-pointer flex rounded-md items-center px-4 py-2 text-sm duration-200 text-black hover:bg-[#6945c5] hover:text-white active:bg-[#4b318c]"
                      >
