...
const CheckOutPage = () => {
  ...
  const grossTotalBeforeDiscount =
    cartTotalAmountNoDis + deliveryFee + handlingCharge;
      ...
      {cartItem[0] ? (
            ...
            <div className="flex flex-col lg:grid grid-cols-2 gap-4">
              ...
              >
                <div className="bg-white rounded-xl shadow-sm px-1 py-4 md:p-6 sticky top-8">
                  <h3 className="text-lg md:text-xl ml-2 md:ml-0 mb-4 md:mb-6 font-semibold text-gray-800 ">
                    Order Summary
                  </h3>
                    ...
                    >
                      <div className="px-2 space-y-1.5 sm:space-y-3 pt-4">
                        ...
                        <div className="flex justify-between">
                          ...
                          <p className="text-sm sm:text-base">
                            <span className="mr-2 text-gray-600 line-through">
                              ₹{cartTotalAmountNoDis.toFixed(2)}
                            </span>
                        ...
                        <div className="flex justify-between font-medium">
                          ...
                          <p>
                            <span className="mr-2 text-gray-600 line-through">
                              ₹{grossTotalBeforeDiscount.toFixed(2)}
                            </span>
                            <span className="text-base sm:text-lg font-bold text-gray-800">
                              ₹{cartTotalAmount.toFixed(2)}
                            </span>
        ...
        >
          ...
          <p className="text-purple-700 max-w-md">
            Your order history is empty. Start shopping to fill it with amazing
            products!
          </p>
