...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            ...
            try {
                const response = await Axios({ ...summarApi.register, data: formData })
    ...
    return (
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center px-4 py-8">
            <motion.div
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 rounded-lg bg-white/5 border backdrop-blur-sm focus:outline-none focus:ring-2 text-white ${errors.name
                            ...
                            >
                                {isSubmitting && (
                                    <motion.span
                                        ...
                                        className="absolute top-0 left-0 h-full w-1/2 bg-white/20 skew-x-[-20deg]"
                                    />
                                )}
